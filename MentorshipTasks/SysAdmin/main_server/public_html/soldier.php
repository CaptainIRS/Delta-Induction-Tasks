         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
               <div class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item">
                     <button class="btn btn-danger navbar-btn mr-4" data-toggle="modal" data-target="#complaintModal">File Complaint</button>
                  </li>
                  <li class="nav-item">
      ...
      <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function () {
          ...
          socket.on('message', function(msg) {
            ...
            $('#messageList').append('<li class="list-group-item p-1">' + '<span class="badge mr-2" style="background-color: hsl(' + hues[msg.username] + ', 100%, 80%)">' + username + '</span>' + '<div class="message">' + converter.makeHtml(msg.message) + '</div>' + '<div class="timestamp"><i>' + (new Date(msg.timestamp)).toLocaleString("en-IN") + '</i></div>' + '</li>');
          ...
          socket.on('room history', function(messages) {
            messages.forEach((msg) => {
              username = (msg.username == me) ? 'You' : msg.username;
              $('#messageList').append('<li class="list-group-item p-1">' + '<span class="badge mr-2" style="background-color: lightgray">' + username + '</span>' + '<div class="message">' + converter.makeHtml(msg.message) + '</div>' + '<div class="timestamp mt-1"><i>' + (new Date(parseInt(msg.timestamp))).toLocaleString("en-IN") + '</i></div>' + '</li>');
              $('#messageList').stop().animate ({
                scrollTop: $('#messageList')[0].scrollHeight
              });
            });
